<?php 
    ...
    require('navbar.php'); 
    // include("../Bdd/cnx.php");
    $mail = $_SESSION['emailUser'];
    
    $demandePrenom = mysqli_query($con, "SELECT prenom FROM inscription WHERE (email='$mail' or nom='$mail')");
 ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                ...
                <?php if($row = mysqli_fetch_assoc($demandePrenom)){
                    $prenom = $row['prenom'];
                ?>
                <a href="presentation.php" class="btn_vert30 btn_presention"><?php echo $prenom ?></a>
                <?php } ?>
